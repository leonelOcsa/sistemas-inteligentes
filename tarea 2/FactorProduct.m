...
%multiplicamos cada un los valores de B por cada uno de los valores de A con .* 
%al mismo tiempo se obtendra su respectivo valor por los indices oobtenidos por indxA y indxB
